...
import type { Host, LogEvent, FlowEvent, Counter } from '../types'
...
export async function patchHost(id: string, patch: { labels?: Record<string, string>; status?: string }): Promise<Host> {
