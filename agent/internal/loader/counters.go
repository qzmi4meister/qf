...
func ReadCounter(objs *BpfObjects, idx uint32) (RuleCounters, error) {
...
func ReadCounters(objs *BpfObjects) ([]RuleCounters, error) {
	var count uint32
...
func ReadSuppressedCount(objs *BpfObjects) (uint64, error) {
	var perCPU []uint64
...
func ResetSuppressedCount(objs *BpfObjects) error {
	var perCPU []uint64
